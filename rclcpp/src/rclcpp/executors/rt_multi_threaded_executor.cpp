...
RTMultiThreadedExecutor::RTMultiThreadedExecutor(
...
RTMultiThreadedExecutor::spin()
{
  ...
  size_t thread_id = 0;
  {
    ...
    for (; thread_id < number_of_threads_ - 1; ++thread_id) {
      auto func = std::bind(&RTMultiThreadedExecutor::run, this, thread_id);
...
size_t
RTMultiThreadedExecutor::get_number_of_threads()
{
  return number_of_threads_;
}

void
RTMultiThreadedExecutor::run(size_t this_thread_number)
{
