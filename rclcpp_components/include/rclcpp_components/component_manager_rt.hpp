 ...
 *
 * - ComponentManagerRT: Node to manage components. It has the services to load, unload and list
 *   current components.
...
#ifndef RCLCPP_COMPONENTS__COMPONENT_MANAGER_RT_HPP__
#define RCLCPP_COMPONENTS__COMPONENT_MANAGER_RT_HPP__
...
class ComponentManagerRTException : public std::runtime_error
{
public:
  explicit ComponentManagerRTException(const std::string & error_desc)
  : std::runtime_error(error_desc) {}
};

/// ComponentManagerRT handles the services to load, unload, and get the list of loaded components.
class ComponentManagerRT : public rclcpp::Node
{
public:
  ...
  ComponentManagerRT(
    ...
    std::string node_name = "ComponentManagerRT",
    const rclcpp::NodeOptions & node_options = rclcpp::NodeOptions()
    .start_parameter_services(false)
    .start_parameter_event_publisher(false));

  RCLCPP_COMPONENTS_PUBLIC
  virtual ~ComponentManagerRT();

  /// Return a list of valid loadable components in a given package.
  /**
   * \param package_name name of the package
   * \param resource_index name of the executable
   * \throws ComponentManagerRTException if the resource was not found or a invalid resource entry
   ...
   */
  RCLCPP_COMPONENTS_PUBLIC
  virtual std::shared_ptr<rclcpp_components::NodeFactoryRT>
  create_component_factory(const ComponentResource & resource);

  /// Member function to set trace file and start tracing
  RCLCPP_COMPONENTS_PUBLIC
  virtual void 
...
protected:
   ...
   * \throws ComponentManagerRTException In the case that the component constructor throws an
